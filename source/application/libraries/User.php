...
class User {
    ...
    public function notify($iduser, $notification = 'new_signup') {
        ...
        $from_email = $this->ci->config->item('smtp_user');
        switch($notification) {
            case 'welcome':
                $this->ci->load->library('email');

                $subject = 'Welcome to Public News';
                $message = '<p>
                                Hello,<br />
                                Welcome to Public News. We are really excited to see you on board. Hope you will enjoy your time here and enrich our portal with valuable contents.
                            </p>
                            <p>
                                Regards,<br />
                                Public News Team
            ...
            default:
                ...
                $message = '<p>
                                Hello,<br />
                                Thank you for joining the Public News. Please follow <a href="'.base_url('account/activate/'.$current_user->code).'">this link</a> to activate your account.
                            </p>
                            <p>
                                You can copy and paste the URL below if the link does not work:<br />

...
class Account extends CI_Controller {
    ...
    public function index() {
        $data['title'] = 'My account | Public News';
    ...
    public function signup() {
        $data['title'] = 'Sign up | Public News';
     ...
     * @param	string	$key for activating account
     * @access  public
     * @return	void
     */

    public function activate($key) {
        $data['title'] = 'Activate account | Public News';
        $this->load->model('user_model', 'um');
    ...
    public function login() {
        ...
        $iduser = $this->session->user_data['iduser'];
        $this->load->model('Profile_model', 'pm');
        $profile = $this->pm->get_by_iduser($iduser);
        if(count($profile) > 0)
          redirect('post');
        else 
          redirect('account');
    ...
    public function retrieve() {
        $data['title'] = 'Retrieve password | Public News';
    ...
    public function reset($key) {
        $data['title'] = 'Reset password | Public News';
        $this->load->model('user_model', 'um');
